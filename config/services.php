...
return [
    ...
    */
    ...
    'google' => [
        'client_id' => env('GOOGLE_CLIENT_ID', '261193827205-k8fval8muhdcl0e1hgqamdg944rno162.apps.googleusercontent.com'),
        'client_secret' => env('GOOGLE_CLIENT_SECRET', 'T0OhoIFVVm7D1XpLAz2G3ugN'),
