...
class ProfileController extends Controller
{
    ...
    public function start_service(Request $request)
    {
        ...
        return (new TripController())->service_update($request);
    }
        ...
        try {
            ...
            if($request->has('service_type')) {
                if($Provider->service) {
                    ...
                    $ProviderService = ProviderService::where('provider_id',Auth::user()->id)->first();
                    if($ProviderService){
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            if ($request->has('mobile'))
                $Provider->mobile = $request->country_code . $request->mobile;
    ...
    public function target(Request $request)
    {
        try {
            //   $query->select(\DB::raw(
                    //                'SUM(ROUND(total) - ROUND(commision)) as overall' ))
                    // })
