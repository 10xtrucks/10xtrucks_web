...
Route::group(['middleware' => ['auth:api']], function () {
	...
	Route::post('/mobile/update' , 'UserApiController@updateMobile');
	...
	Route::post('/payment/paypal' , 	'PaymentController@payment');
    Route::post('/add/money/paypal' , 	'PaymentController@add_money');
    ...
    Route::post('/paystack/status', 'PaymentController@paystack_status');

    //wallet paystack status
     Route::post('/paystack/wallet/status', 'PaymentController@paystack__wallet_status');
