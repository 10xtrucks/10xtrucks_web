...
Route::group(['as' => 'dispatcher.', 'prefix' => 'dispatcher'], function () {
	...
	Route::get('/bidding/providers', 'DispatcherController@biddingProviderList')->name('bidding.providers');
});
...
// Route::get('geo/fencing', 'AdminController@geo_fencing')->name('geo.fencing');
// Route::post('geo/fencing/store', 'AdminController@geo_fencing_store')->name('geo_fencing.store');
...
Route::get('cancelled', 'Resource\TripResource@cancelled')->name('requests.cancelled');
Route::get('cancelledbyUser', 'Resource\TripResource@cancelledbyUser')->name('requests.cancelledbyUser');
Route::get('cancelledbyProvider', 'Resource\TripResource@cancelledbyProvider')->name('requests.cancelledbyProvider');
