...
function AutocompleteDirectionsHandler(map) {
    ...
    var originInput = document.getElementById('origin-input'+id);
    var destinationInput = document.getElementById('destination-input'+id);
    var modeSelector = document.getElementById('mode-selector'+id);
    var originLatitude = document.getElementById('origin_latitude'+id);
    var originLongitude = document.getElementById('origin_longitude'+id);
    var destinationLatitude = document.getElementById('destination_latitude'+id);
    var destinationLongitude = document.getElementById('destination_longitude'+id);
