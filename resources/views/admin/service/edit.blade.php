        ...
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.service.update', $service->id )}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                    <label for="name" class="col-xs-2 col-form-label">@lang('admin.provides.service_name')</label>
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ $service->name }}" name="name" required id="name" placeholder="@lang('admin.provides.service_name')">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="provider_name" class="col-xs-2 col-form-label">@lang('admin.provides.provider_name')</label>
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ $service->provider_name }}" name="provider_name" required id="provider_name" placeholder="@lang('admin.provides.provider_name')">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ $service->minute }}" name="minute" required id="minute" placeholder="@lang('admin.service.unit_time1')">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ $service->price }}" name="price" required id="price" placeholder="@lang('admin.service.unit')">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="maximum_weight" class="col-xs-2 col-form-label">@lang('admin.service.max_weight')</label>
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ $service->maximum_weight }}" name="maximum_weight" required id="maximum_weight" placeholder="@lang('admin.service.max_weight')">
                    </div>
                </div>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" value="{{ $service->capacity }}" name="capacity" required id="capacity" placeholder="@lang('admin.service.Seat_Capacity')">
                    </div>
                </div>
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                    <label for="choosetype" class="col-xs-12 col-form-label">@lang('admin.static_content_user.user_type')</label>
                                 <div class="col-md-6">
                                <input type="radio" placeholder=""  name="user_type" class="user_type" value="BUSINESSUSER"
                                {{$service->user_type  == 'BUSINESSUSER' ? 'checked' : ''}}>@lang('admin.service.business_user')
                                </div>
                                 <div class="col-md-6">
                                <input type="radio" placeholder="" class="user_type" name="user_type" value="NORMAL" {{$service->user_type == 'NORMAL' ? 'checked' : ''}}>@lang('admin.service.normal_user')
                                </div>
                </div>
                <div class="form-group row">
