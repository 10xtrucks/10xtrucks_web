            ...
            <div class="box box-block bg-white">
	            ...
	            <form class="form-horizontal" action="{{route('admin.send.push')}}" method="POST" role="form" id="create_push">
	            	...
	            	<div class="form-group row">
						...
						<div class="col-xs-10">
							<select class="form-control" name="send_to" onchange="switch_send(this.value)">
								<option value="ALL">@lang('admin.push.all_user_drive')</option>
								<option value="USERS">@lang('admin.push.all_user')</option>
								<option value="PROVIDERS">@lang('admin.push.all_drive')</option>
							</select>
						</div>
					</div>

					<div class="form-group row" id="for_users" style="display: none;">
						<label class="col-xs-2 col-form-label">@lang('admin.push.user_cond')</label>
						<div class="col-xs-5">
					...
					<div class="form-group row" id="for_providers" style="display: none;">
						<label class="col-xs-2 col-form-label">@lang('admin.push.drive_cond')</label>
						<div class="col-xs-5">
					...
					<div class="form-group row">
						<label for="message" class="col-xs-2 col-form-label">@lang('admin.message')</label>
						<div class="col-xs-10">
							<textarea maxlength="200" class="form-control" rows="3" name="message" required id="message" placeholder="@lang('admin.message')" ></textarea>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">@lang('admin.push.scchedule_push')</h4>
      </div>
      <form>
      <div class="modal-body">
        
        <label>@lang('admin.push.date')</label>
        <input value="{{date('m/d/Y')}}" class="form-control" type="text" id="datepicker" placeholder="@lang('admin.push.date')" name="schedule_date">
        <label>@lang('admin.push.time')</label>
        <input value="{{date('H:i')}}" class="form-control" type="text" id="timepicker" placeholder="@lang('admin.push.time')" name="schedule_time">

      </div>
      <div class="modal-footer">
        <button type="button" id="schedule_button" class="btn btn-default" data-dismiss="modal">@lang('admin.push.Schedule_Push')</button>
      </div>
