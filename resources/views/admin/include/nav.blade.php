		...
		<ul class="sidebar-menu">
			...
			<li class="with-sub">
				...
				<ul>
					...
					<li><a href="{{ route('admin.promocode.create') }}">@lang('admin.include.add_new_promocode')</a></li>
				</ul>
			</li>
			<!-- <li class="with-sub">
			...
			<li>
				<a href="{{ route('admin.terms') }}" class="waves-effect waves-light">
					<span class="s-icon"><i class="ti-help"></i></span>
					<span class="s-text">@lang('admin.include.terms_condition')</span>
				</a>
			</li>
			<!-- <li>
