									...
									<div class="box bg-white">
										...
										@if(count($Providers) != 0)
								            <table class="table table-striped table-bordered dataTable" id="table-2">
								                <thead>
								                   <tr>
														<td>@lang('fleet_dispatcher.provider_name')</td>
														<td>@lang('fleet_dispatcher.mobile')</td>
														<td>@lang('fleet_dispatcher.status')</td>
														<td>@lang('fleet_dispatcher.total_rides')</td>
														<td>@lang('fleet_dispatcher.total_earning')</td>
														<td>@lang('fleet_dispatcher.commission')</td>
														<td>@lang('fleet_dispatcher.joined_at')</td>
														<td>@lang('fleet_dispatcher.details')</td>
													</tr>
								                </thead>
								                <tbody>
