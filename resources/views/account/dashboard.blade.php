    ...
    <div class="row row-md">
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">@lang('fleet_dispatcher.total_no_delviery')</h6>
		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">@lang('fleet_dispatcher.service_type')</h6>
		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">@lang('fleet_dispatcher.cancelled_delive')</h6>
		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				<div class="t-icon right"><span class="bg-primary"></span><i class="ti-view-grid"></i></div>
				<div class="t-content">
					<h6 class="text-uppercase mb-1">@lang('fleet_dispatcher.user_cancl')</h6>
		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">@lang('fleet_dispatcher.provi_cancl')</h6>
		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">@lang('fleet_dispatcher.no_fleet')</h6>
		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				<div class="t-icon right"><span class="bg-success"></span><i class="ti-bar-chart"></i></div>
				<div class="t-content">
					<h6 class="text-uppercase mb-1">@lang('fleet_dispatcher.no_schedul')</h6>
		...
		<div class="col-md-12">
				<div class="box bg-white">
					<div class="box-block clearfix">
						<h5 class="float-xs-left">@lang('fleet_dispatcher.recent_delivery')</h5>
							...
							<tr>
								...
								<td>
									@if($ride->status != "CANCELLED")
										<a class="text-primary" href="{{route('account.requests.show',$ride->id)}}"><span class="underline">@lang('fleet_dispatcher.view_ride')</span></a>
									@else
