		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				...
				<div class="t-content">
					...
					<i class="fa fa-caret-up text-success mr-0-5"></i><span>@lang('fleet_dispatcher.from') {{$rides->count()}} @lang('fleet_dispatcher.delivery')</span>
				</div>
			</div>
		</div>
		<div class="col-lg-3 col-md-6 col-xs-12">
							...
							<tr>
								...
								<td>
									@if($ride->status != "CANCELLED")
										<a class="text-primary" href="{{route('fleet.requests.show',$ride->id)}}"><span class="underline">@lang('fleet_dispatcher.view_delivery')</span></a>
									@else
