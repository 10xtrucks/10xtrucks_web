...
<div style="line-height:20px;font-size:1px">&#160;</div><!--[if mso]></td></tr></table><![endif]-->
    ...
    <div style="color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;"> 
        <div style="font-size:12px;line-height:18px;color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">{{trans('unauthorized.email.fast_courier')}}</p></div>  
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
</div>
...
<!--[if mso]></td></tr></table><![endif]-->
    ...
    <div style="color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%; padding-right: 10px; padding-left: 10px; padding-top: 20px; padding-bottom: 10px;"> 
        <div style="font-size:12px;line-height:18px;color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center; text-transform: uppercase;">{{trans('unauthorized.email.with')}} {{Setting::get('site_title')}}, {{trans('unauthorized.email.entered_part')}}</p></div>   
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
</div>
...
<div align="center" class="button-container center " style="padding-right: 10px; padding-left: 10px; padding-top:25px; padding-bottom:10px;">
  <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top:25px; padding-bottom:10px;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:37pt; v-text-anchor:middle; width:106pt;" arcsize="8%" strokecolor="#F9B419" fillcolor="#F9B419"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; font-size:20px;"><![endif]-->
    <div style="color: #ffffff; background-color: #F9B419; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; max-width: 142px; width: 62px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 5px; padding-right: 40px; padding-bottom: 5px; padding-left: 40px; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; text-align: center; mso-border-alt: none;"> <a style="text-decoration: none;color: #fff;" href="{{ url('/') }}">
      <span style="font-size:12px;line-height:24px;"><span style="font-size: 20px; line-height: 32px;"><strong><span style="line-height: 32px;">{{trans('unauthorized.email.go_to')}}</span></strong></span></span></a>
    </div>
...
<div style="line-height:5px;font-size:1px">&#160;</div><!--[if mso]></td></tr></table><![endif]-->
    ...
    <div style="color:#FFFFFF;line-height:120%;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 5px;">  
        <div style="font-size:12px;line-height:14px;color:#FFFFFF;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center"><span style="font-size: 18px; line-height: 21px;"><strong>{{trans('unauthorized.email.provider_app')}}</strong></span></p></div>  
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
</div>
...
<div align="center" style="padding-right: 0px; padding-left: 0px; padding-bottom: 0px;" class="">
 ...
 ">{{trans('unauthorized.provider.email')}} :<span style="color: rgb(255, 255, 255); font-size: 12px; line-height: 14px;"><span style="font-size: 12px; line-height: 14px;"></span><span style="font-size: 12px; line-height: 14px;">{{Setting::get('contact_email')}}</span></span></p></a>  </div> 
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
</div>
