...
<div class="pro-dashboard-head">
    <div class="container">
        <a href="#" class="pro-head-link active">Delivered Now</a>
    </div>
</div>
...
@elseif(Auth::user()->status=='onboarding')
<div class="pro-dashboard-head">
    <div class="container">
        <a href="#" class="pro-head-link active">@lang('provider.document_pending')</a>
    </div>
            ...
            <div class="row no-margin">
                <div className="col-md-12">  
                    <form method="POST" action="provider/profile/available">
                        ...
                        <a href="#" class="full-primary-btn">@lang('provider.online')</a>
                    </form>
                </div>
            </div>
        </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key={{Setting::get('google_map_key')}}&libraries=places" defer></script>
