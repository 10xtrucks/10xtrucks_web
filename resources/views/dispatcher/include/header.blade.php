				...
				<li class="nav-item dropdown hidden-sm-down">
					...
					<div class="dropdown-menu dropdown-menu-right animated fadeInUp">
						<a class="dropdown-item" href="{{route('dispatcher.profile')}}">
							<i class="ti-user mr-0-5"></i> @lang('fleet_dispatcher.profile')
						</a>
						<a class="dropdown-item" href="{{route('dispatcher.password')}}">
							<i class="ti-settings mr-0-5"></i> @lang('fleet_dispatcher.change_password')
						</a>
						<div class="dropdown-divider"></div>
						<a class="dropdown-item" href="{{ url('/dispatcher/logout') }}"
                            onclick="event.preventDefault();
                                     document.getElementById('logout-form').submit();"><i class="ti-power-off mr-0-5"></i> @lang('fleet_dispatcher.sign_out')</a>
					</div>
				</li>
			</ul>
