        ...
        <div class="row no-margin edit-pro">
            ...
            {{ csrf_field() }}
                ...
                {{-- <div class="form-group row">
                    <label for="choosetype" class="col-xs-12 col-form-label">@lang('unauthorized.user.user_type')</label>
                    <div class="col-md-6">
                        <input type="radio" placeholder=""  name="user_type" class="user_type" value="BUSINESSUSER"
                        {{Auth::user()->user_type  == 'BUSINESSUSER' ? 'checked' : ''}}>@lang('unauthorized.user.business_user')
                    </div>
                    <div class="col-md-6">
                        <input type="radio" placeholder="" class="user_type" name="user_type" value="NORMAL" {{Auth::user()->user_type == 'NORMAL' ? 'checked' : ''}}>@lang('unauthorized.user.normal_user')
                    </div>
                </div> --}}
